						...
						<tbody>							
							...
							<tr>
								...
								<td class="text-center"><a
									...
									data-unit="<%=list.getUnit()%>" data-note="<%=list.getNote()%>"
		...
		$(document).ready(function() {
					$('.btn-delete').on(
							...
							function() {
								var id = $(this).data("id");
								$modal = $('.modal-delete');
								$modal.find("#set_con_code").text(
										"รหัสวัสดุ : " + $(this).data("code"));
								$modal.find("#set_con_name").text(
										"ชื่อวัสดุ : " + $(this).data("name"));
								$modal.modal('show');
								$modal.find(".btn-modal-delete").on("click",
										function() {
											$.ajax({
												type : "POST",
												url : "DeleteConsum",
