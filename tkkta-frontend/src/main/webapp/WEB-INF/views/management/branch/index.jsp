		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<search_form:form action="${root_action}/management/branch/list" method="get" modelAttribute="search_form" id="form-search" class="form-inline">
							<div class="form-group">
								<search_form:input path="branchId" class="form-control" placeholder="รหัสสาขา"/>
							</div>
							<div class="form-group">
