...
<form:form action="${root_action}/management/branch/delete" method="post"
	...
	<div class="modal-body">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<h4>คำเตือน !!</h4>
				<p>คูณกำลังดำเนินการลบข้อมูลสาขา  ${delete_form.branchId} :  ${delete_form.branchName} ออกจากฐานข้อมูลของระบบ</p>
			</div>
		</div>
	</div>
