		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<search_form:form action="${root_action}/problem/list" method="get" modelAttribute="search_form" id="form-search" class="form-inline">
							...
							<a href="${root_action}/problem/create" id="btn-create" class="btn btn-primary" style="margin: 0px;">Create</a>
						</search_form:form>
					</div>
					</div>
					<br>
