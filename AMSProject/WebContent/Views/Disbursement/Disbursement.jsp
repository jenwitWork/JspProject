			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label for="Inputname" class="col-sm-4 control-label">ชื่อผู้เบิก</label>
							<div class="col-sm-8">
								<input type="text" class="form-control">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">หมายเหตุการเบิก</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">วันที่ทำการาเบิก</label>
