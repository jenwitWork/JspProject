                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="margin-bottom-50">
                                                                <create_form:form action="${root_action}/document/create" method="post" modelAttribute="create_form" class="ng-pristine ng-valid" id="form-add" enctype="multipart/form-data">
                                                                    <create_form:hidden path="createdUser" value="${gobalUser.username}" />
                                                                    <input type="hidden" name="detail" id="detail" value="">
                                                                    <div class="form-group row">
                                                                        <div class="col-md-12 text-right">
                                                                            <button type="submit" name="submit" class="btn width-150 btn-success">สร้างเอกสาร</button>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <create_form:select path="branchId" class="form-control input-sm">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <create_form:input path="createdDate" value="${now}" class="form-control input-sm" disabled="true" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col-md-2">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <create_form:select path="serieId" class="form-control input-sm">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <create_form:select class="form-control input-sm" path="pbType">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <create_form:input path="caseNameTh" class="form-control input-sm" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col-md-2">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <create_form:input path="caseNameEn" class="form-control input-sm" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-md-4">
                                                                            <input class="filestyle" data-buttonBefore="true" data-buttonName="btn-danger" data-size="sm" data-iconName="fa fa-file-pdf-o" data-buttonText="เลือกไฟล์ PDF" type="file" name="pdf" id="pdf" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col-md-4">
                                                                            <input class="filestyle" data-buttonBefore="true" data-buttonName="btn-primary" data-size="sm" data-iconName="fa fa-picture-o" data-buttonText="เลือกไฟล์รูปภาพ" type="file" name="images" id="images" accept="image/*" multiple="multiple" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col-md-4">
                                                                            <input class="filestyle" data-buttonBefore="true" data-buttonName="btn-success" data-size="sm" data-iconName="fa fa-video-camera" data-buttonText="เลือกไฟล์ VDO" type="file" name="videos" id="videos" accept="video/*" />
                                                                        </div>
                                                                    </div>
                                                                </create_form:form>
                                                            </div>
