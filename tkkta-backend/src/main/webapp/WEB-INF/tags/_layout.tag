				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>Cars</h3>
							<ul class="nav side-menu">
								<li><a href="<%=request.getContextPath()%>/car-serie"><i class="fa fa-truck"></i> รุ่นรถ</a></li>
								<li><a href="<%=request.getContextPath()%>/car-model?serie_id="><i class="fa fa-car"></i> แบบรถ</a></li>								
