...
<div class="right_col" role="main">
	...
	<div class="row tile_count">
		<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
			<span class="count_top"><i class="fa fa-calculator"></i> Total Handheld</span>
			<div class="count">310</div>
			<span class="count_bottom"><i class="green">4% </i> From last
				Week</span>
		</div>
		<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
			<span class="count_top"><i class="fa fa-desktop"></i> Total Computer</span>
			<div class="count">109</div>
			<span class="count_bottom"><i class="green"><i
							class="fa fa-sort-asc"></i>3% </i> From last Week</span>
		</div>
		<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
			<span class="count_top"><i class="fa fa-print"></i> Total Printer</span>
							...
							<td>
								<table class="tile_info">
									<tr>
										<td>
											<p>
												<i class="fa fa-square blue"></i>MC3190
											</p>
										</td>
										<td>30</td>
									</tr>
									<tr>
										<td>
											<p>
												<i class="fa fa-square green"></i>MC32N0
											</p>
										</td>
										<td>10</td>
									</tr>
									<tr>
										<td>
											<p>
												<i class="fa fa-square purple"></i>MC9190
											</p>
										</td>
										<td>20</td>
									</tr>
